...
namespace ImportBrandData_FromExcel
{
   public class Import_BrandMaster
   {
       ...
       public Boolean IsImportFileInValid()
       {
           ...
           try
           {
               ...
               string BrandName = "";
               Int16 BrandNamecol = 1;
               //ExcelPackage p = new ExcelPackage(new System.IO.FileInfo(excelfile));
               ExcelWorksheet excelsht = p.Workbook.Worksheets[sheetname];
               BrandName = Convert.ToString(excelsht.Cells[r, BrandNamecol].Value);
               ...
               if (BrandName != "")
               {
                   ...
                   for (r = 2; r <= dimend.Row; r++)
                   {
                       ...
                       brand_name = Convert.ToString(excelsht.Cells[r, BrandNamecol].Value);
                       ...
                       //    isInsert = true;
                       //
                       if (lastcolumnname.ToLower() != "brand_id")
                       {
                           ...
                           if (BrandName.Trim().Length == 0)
                           {
                               //invalidcols += "barcode, ";
                               isinvalid = true;
                               txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'BrandName' is missing.";
                           }
                       ...
                       else //update
                       {
                           ...
                           {
                               if (excelsht.Cells[1, c].Value.ToString() == "BrandName")
                               {
               ...
               for (r = 2; r <= dimend.Row; r++)
               {
                   ...
                   if (sheetname == "Brand")
                   {
                       if (ignoreerror)
                       {
                           ...
                           BrandName = Convert.ToString(excelsheet.Cells[r, BrandNamecol].Value);
                           ...
                           if (BrandName.Trim().Length == 0)
                           {
                               ...
                               txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'Brand Name' is missing.";
                           }
                   ...
                   if (sheetname == "Brand")
                   {
                       ...
                       Status = Convert.ToString(excelsheet.Cells[r, StatusCol].Value);
                       Remark = Convert.ToString(excelsheet.Cells[r, RemarkCol].Value);
                       eanbarcode = Convert.ToString(excelsheet.Cells[r, eanbarcodeCol].Value);
                       Item = Convert.ToString(excelsheet.Cells[r, ItemCol].Value);
                       SubGroup = Convert.ToString(excelsheet.Cells[r, SubGroupCol].Value);
                       PurTax = Convert.ToString(excelsheet.Cells[r, PurTaxCol].Value);
                       ...
                       if (dt1.Rows.Count > 0)
                       {
                           txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No: " + (r - 1).ToString() + " Brand '" + BrandName + "' Already Exists \r\n\r\n";
                           trans.Rollback();
                           goto Err;
                       }
                   ...
                   for (c = 1; c <= dimend.Column; c++)
                   {
                       error = ReadAndCreate(excelsheet, r, c, trans, ref columnstring, ref valuestring, ref udfcolumnstring, ref udfvaluestring, ref brandid, ref brandkey);
                   }
                   ...
                   if (sheetname == "Brand")
                   {
                       error = NewRecordId("Brand", "Brand_id", trans, ref brandid);
                       ...
                       columnstring = "CoBr_Id,Brand_Id,Brand_Key," + columnstring + ",Alt_Code,Status,Created_By,Created_Dt,Updated_By,Updated_Dt,synchcloud,Auto_Code";
                       valuestring = "'" + branchid + "'," + brandid + ",'" + branchid + brandkey + "'," + valuestring + ",'',1," + importuser + ",'" + dttime.ToString("MM/dd/yyyy hh:mm tt") + "',NULL,NULL,0,''";

                       sql = "Insert into Brand (" + columnstring + ") values (" + valuestring + ")";
       ...
       private void UpdateEntryInTable(ExcelWorksheet excelsheet)
       {
           ...
           try
           {
               ...
               for (r = 2; r <= dimend.Row; r++)
               {
                   ...
                   brandkey = updateonvalue;

                   for (c = 1; c <= dimend.Column; c++)
                   {
                       error = UpdateReadAndCreate(excelsheet, r, c, trans, ref columnstring, ref valuestring, ref udfvaluestring, ref brandid, ref brandkey);
                       if (error)
                       {
                           goto Err;
                       }
               ...
               Err:
                   ...
                   if (!error)
                   {
                       ...
                       sql = "Update Brand Set " + valuestring + " Where " + updateoncolumn + " = " + updateonvalue + "";
                       sw.WriteLine(sql);
                       error = ExecuteQuery(sql, trans);
       ...
       //
       private Boolean ReadAndCreate(ExcelWorksheet excelsheet, Int32 r, Int32 c, SqlTransaction trans, ref string columnstring, ref string valuestring, ref string udfcolumnstring, ref string udfvaluestring, ref Int32 brandid, ref Int32 brandkey)
       {
           try
           {
               string dbcolname = "";
               ...
               if (srchcols.Count != 0 || excelcolhdr == "BrandName" || excelcolhdr == "AltCode")
               {
                   ...
                   else if (dbcolname.ToLower() != "brand_id")
                   {
                   ...
                   {
                       if (dbcolname.ToLower() == "brand_name")
                       {
                           BrandName = val;
                       }
       ...
       private Boolean UpdateReadAndCreate(ExcelWorksheet excelsheet, Int32 r, Int32 c, SqlTransaction trans, ref string columnstring, ref string valuestring, ref string udfvaluestring, ref Int32 itemid, ref Int32 itemkey)
       {
           try
           {
               ...
               if (ignoreerror)
               {
                   if (srchcols.Count == 0 && (excelcolhdr != "brand_name"))
                   {
                       return false;
                   }
               }
