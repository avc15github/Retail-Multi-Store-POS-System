...
namespace ImportItemData_FromExcel
{
  public class Import_ItemMaster
    {
        ...
        public Boolean IsImportFileInValid()
        {
            ...
            try
            {
                ...
                if (sheetname == "Item")
                {
                    ...
                    Int16 Item_DescCol = 1;
                    Int16 itemnamecol = 2;
                    Int16 AbbrCol = 3;
                    Int16 ItemDescCol = 4;
                    Int16 ItemGroupCol = 7;
                    Int16 subgroupcol = 8;
                    Int16 unitcol = 13;
                    
                    Int16 SalesTaxCol = 31;
                    //
                    ...
                    for (r = 2; r <= dimend.Row; r++)
                    {
                        ...
                        itemname = Convert.ToString(excelsht.Cells[r, itemnamecol].Value);
                        Abbr = Convert.ToString(excelsht.Cells[r, AbbrCol].Value);
                        Item_Desc = Convert.ToString(excelsht.Cells[r, Item_DescCol].Value);
                        ItemGroup = Convert.ToString(excelsht.Cells[r, ItemGroupCol].Value);
                        subgroup = Convert.ToString(excelsht.Cells[r, subgroupcol].Value);
                        unit = Convert.ToString(excelsht.Cells[r, unitcol].Value);
                        SalesTax = Convert.ToString(excelsht.Cells[r, SalesTaxCol].Value);
                        ...
                        if (lastcolumnname.ToLower() != "item_id")
                        {
                             ...
                             if (itemname.Trim().Length == 0)
                            {
                                ...
                                isinvalid = true;
                                txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'ItemName' is missing.";
                            }
                            ...
                            else if (Item_Desc.Trim().Length == 0)
                            {
                                //invalidcols += "Subgroup, ";
                                isinvalid = true;
                                txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'ItemDesc' is missing.";
                            }
                            else if (ItemGroup.Trim().Length == 0)
                            {
                                //invalidcols += "Subgroup, ";
                                isinvalid = true;
                                txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'ItemGroup' is missing.";
                            }
                            else if (subgroup.Trim().Length == 0)
                            {
                                //invalidcols += "Subgroup, ";
                                isinvalid = true;
                                txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'SubGroup' is missing.";
                            }
                            ...
                            else if (unit.Trim().Length == 0)
                            {
                                //invalidcols += "Unit, ";
                                isinvalid = true;
                                txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'Unit' is missing.";
                            }
                             else if (SalesTax.Trim().Length == 0)
                            {
                                //invalidcols += "Unit, ";
                                isinvalid = true;
                                txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'SalesTax' is missing.";
                            }
                        ...
                        else //update
                        {
                            ...
                            {
                                if (excelsht.Cells[1, c].Value.ToString() == "Item_Name" || excelsht.Cells[1, c].Value.ToString() == "Abbr" || excelsht.Cells[1, c].Value.ToString() == "Item_Desc" || excelsht.Cells[1, c].Value.ToString() == "ItemGrp_Key" || excelsht.Cells[1, c].Value.ToString() == "ItemSubGrp_Key")
                                {
                ...
                for (r = 2; r <= dimend.Row; r++)
                {
                    ...
                    if (sheetname == "Item")
                    {
                        if (ignoreerror)
                        {
                            ...
                            ItemDesc = Convert.ToString(excelsheet.Cells[r, ItemDescCol].Value);
                            itemname = Convert.ToString(excelsheet.Cells[r, itemnamecol].Value);
                            ...
                            SaleTax = Convert.ToString(excelsheet.Cells[r, SaleTaxcol].Value);
                            ...
                            else if (ItemDesc.Trim().Length == 0)
                            {
                                //invalidcols += "Subgroup, ";
                                IgnorErrorExcel = true;
                                txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'ItemDesc' is missing.";
                            ...
                            else if (unit.Trim().Length == 0)
                            {
                             ...
                             else if (SaleTax.Trim().Length == 0)
                            {
                                //invalidcols += "Unit, ";
                                IgnorErrorExcel = true;
                                txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of 'Tax_Key' is missing.";
                            }
                                                        
                            ProductName  = Convert.ToString(excelsheet.Cells[r, itemnamecol].Value);
                    ...
                    if (sheetname == "Item")
                    {
                        ...
                        Item = Convert.ToString(excelsheet.Cells[r, ItemCol].Value);
                        Group = Convert.ToString(excelsheet.Cells[r, GroupCol].Value);
                        SubGroup = Convert.ToString(excelsheet.Cells[r, SubGroupCol].Value);
                        Brand = Convert.ToString(excelsheet.Cells[r, BrandCol].Value);
                        Unit = Convert.ToString(excelsheet.Cells[r, UnitCol].Value);
                        Tax = Convert.ToString(excelsheet.Cells[r, TaxCol].Value);
                        
                        
                       
                        sql = "SELECT ITEM_NAME FROM ITEM WHERE Item.Item_Name ='" + Item + "' ";
                        DataTable dt2 = null;
                        error = GetTable(sql, trans, ref dt2);
                        if (dt2.Rows.Count > 0)
                        {
                            txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No: " + (r - 1).ToString() + " Item  '" + Item + "' Already Exists \r\n\r\n";
                            trans.Rollback();
                            goto Err;
                        }
                        sql = "select * from TaxTermsTDS  Where  TxTmTDS_Name = '" + Tax + "'";
                        DataTable dt4 = null;
                        error = GetTable(sql, trans, ref dt4);
                        if (dt4.Rows.Count == 0)
                        {
                            txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No: " + (r - 1).ToString() + " Tax '" + Tax + "' Not Created \r\n\r\n";
                            trans.Rollback();
                            goto Err;
                        }
                        sql = "Select * from ItemGrp Where ItemGrp_name = '" + Group + "'";
                        DataTable dt5 = null;
                        error = GetTable(sql, trans, ref dt5);
                        if (dt5.Rows.Count == 0)
                        {
                            txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No: " + (r - 1).ToString() + " ItemGroup '" + Group + "' Not Created \r\n\r\n";
                            trans.Rollback();
                            goto Err;
                        }
                        sql = "Select * from ItemSubGrp Where ItemSubGrp_name = '" + SubGroup + "'";
                        DataTable dt6 = null;
                        error = GetTable(sql, trans, ref dt6);
                        if (dt6.Rows.Count == 0)
                        {
                            txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No: " + (r - 1).ToString() + " ItemSubGroup '" + SubGroup + "' Not Created \r\n\r\n";
                            trans.Rollback();
                            goto Err;
                        }
                        sql = "Select * from Unit Where Unit_name = '" + Unit + "'";
                        DataTable dt7 = null;
                        error = GetTable(sql, trans, ref dt7);
                        if (dt7.Rows.Count == 0)
                        {
                            txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No: " + (r - 1).ToString() + " Unit '" + Unit + "' Not Created \r\n\r\n";
                            trans.Rollback();
                            goto Err;
                        }
                    }
                    ...
                    for (c = 1; c <= dimend.Column; c++)
                    {
                        error = ReadAndCreate(excelsheet, r, c, trans, ref columnstring, ref valuestring, ref udfcolumnstring, ref udfvaluestring, ref itemid, ref itemkey);
                    }
                    ...
                    if (sheetname == "Item")
                    {
                        error = NewRecordId("item", "item_id", trans, ref itemid);
                        ...
                        columnstring = "Cobr_id, Item_Id,Item_Key," + columnstring + ",Status,Created_by, Created_dt";
                        valuestring = "'" + branchid + "'," + itemid + ",'" + branchid + itemid + "'," + valuestring + ",1," + importuser + ",'" + dttime.ToString("MM/dd/yyyy hh:mm tt") + "'";

                        sql = "Insert into Item (" + columnstring + ") values (" + valuestring + ")";
                    ...
                    else
                    {
                        ...
                        if (sheetname == "Item")
                        {
                            ...
                            //txtstatus.AppendText("\r\n Item: " + ProductName  + " updated successfully");
                        }
                        else
                        {
            ...
            try
            {
                ...
                for (r = 2; r <= dimend.Row; r++)
                {
                    ...
                    if (sheetname == "Item")
                    {
                        ...
                        //ProductCode  = Convert.ToString(excelsheet.Cells[r, EANBarcodeCol].Value);
                        ProductName = Convert.ToString(excelsheet.Cells[r, ItemCol].Value);
                    }
                    ...
                    if (!error)
                    {
                        ...
                        sql = "Update Item Set " + valuestring + " Where " + updateoncolumn + " = " + updateonvalue + "";
                        sw.WriteLine(sql);
                        error = ExecuteQuery(sql, trans);
        ...
        //
        private Boolean ReadAndCreate(ExcelWorksheet excelsheet, Int32 r, Int32 c, SqlTransaction trans, ref string columnstring, ref string valuestring, ref string udfcolumnstring, ref string udfvaluestring, ref Int32 itemid, ref Int32 itemkey)
        {
            try
            {
                string dbcolname = "";
                ...
                if (srchcols.Count != 0 || excelcolhdr == "ItemGroup" || excelcolhdr == "DRS_SEQ")
                {
                    ...
                    else if (dbcolname.ToLower() != "item_id" && dbcolname.ToLower() != "itemgroup")
                    {
                    ...
                    {
                       if (dbcolname.ToLower() == "itemgrp_key")
                       {
                           sql = "select ItemGrp_key From ItemGrp where itemgrp_name = '" + val.Trim() + "'";
                           DataTable dt4 = null;
                           error = GetTable(sql, trans, ref dt4);
                           val = Convert.ToString(dt4.Rows[0][0]);

                       }
                       else if (dbcolname.ToLower() == "itemsubgrp_key")
                       {
                           sql = "select itemsubgrp_key From itemsubgrp where itemsubgrp_name = '" + val.Trim() + "'";
                           DataTable dt4 = null;
                           error = GetTable(sql, trans, ref dt4);
                           val = Convert.ToString(dt4.Rows[0][0]);

                       }
                       else if (dbcolname.ToLower() == "unit_key" || dbcolname.ToLower() == "convunit_key" || dbcolname.ToLower() == "purunit_key" || dbcolname.ToLower() == "saleunit_key")
                       {
                           sql = "select unit_key From unit where unit_name = '" + val.Trim() + "'";
                           DataTable dt4 = null;
                           error = GetTable(sql, trans, ref dt4);
                           val = Convert.ToString(dt4.Rows[0][0]);

                       }                       
                       else if (dbcolname.ToLower() == "brand_key")
                       {
                           sql = "select brand_key From brand where brand_name = '" + val.Trim() + "'";
                           DataTable dt4 = null;
                           error = GetTable(sql, trans, ref dt4);
                           val = Convert.ToString(dt4.Rows[0][0]);
                       }
                       else if (dbcolname.ToLower() == "height_unit")
                       {
                           val = "";
                       }
                       else if (dbcolname.ToLower() == "tax_key")
                       {
                           sql = "select TxTmTDS_Key From TaxTermsTDS where TxTmTDS_Name = '" + val.Trim() + "'";
                           DataTable dt4 = null;
                           error = GetTable(sql, trans, ref dt4);
                           val = Convert.ToString(dt4.Rows[0][0]);
                       }
        ...
        private Boolean UpdateReadAndCreate(ExcelWorksheet excelsheet, Int32 r, Int32 c, SqlTransaction trans, ref string columnstring, ref string valuestring, ref string udfvaluestring, ref Int32 itemid, ref Int32 itemkey)
        {
            try
            {
                ...
                if (ignoreerror)
                {
                    if (srchcols.Count == 0 && (excelcolhdr != "ItemGroup" && excelcolhdr != "ItemGroupCode" && excelcolhdr != "ItemSubGroupCode"))
                    {
                        return false;
                    }
                }
                ...
                if (ignoreerror)
                {
                    ...
                    if (excelcolhdr == "ItemGroup" || excelcolhdr == "ItemGroupCode" || excelcolhdr == "ItemSubGroupCode")
                    {
                    ...
                    else if (srchcols[0].ColumnName.ToString() == "EAN_Barcode" || srchcols[0].ColumnName.ToString() == "Item_Name" || srchcols[0].ColumnName.ToString() == "Abbr" || srchcols[0].ColumnName.ToString() == "Item_Desc" || srchcols[0].ColumnName.ToString() == "ItemGroupCode" || srchcols[0].ColumnName.ToString() == "ItemGroup" || srchcols[0].ColumnName.ToString() == "ItemSubGroupCode" || srchcols[0].ColumnName.ToString() == "ItemSubGrp_Id" || srchcols[0].ColumnName.ToString() == "Unit_Id" || srchcols[0].ColumnName.ToString() == "ConvUnit_Id" || srchcols[0].ColumnName.ToString() == "Conv_Qty" || srchcols[0].ColumnName.ToString() == "PurRate" || srchcols[0].ColumnName.ToString() == "PurUnit_Id" || srchcols[0].ColumnName.ToString() == "SaleRate" || srchcols[0].ColumnName.ToString() == "SaleUnit_Id" || srchcols[0].ColumnName.ToString() == "MRP" || srchcols[0].ColumnName.ToString() == "Tax_Incl" || srchcols[0].ColumnName.ToString() == "SaleRateBeforeTax" || srchcols[0].ColumnName.ToString() == "DefaultQty" || srchcols[0].ColumnName.ToString() == "Maintain_Stk")
                    {
                        if (Convert.ToString(excelsheet.Cells[r, c].Value) == "")
                        {
                            txterrorstatus.Text += "**********ERROR********** \r\n\r\n Line No:" + (r - 1).ToString() + " Required value of '" + srchcols[0].ColumnName.ToString() + "' is missing. \r\n\r\n ";
